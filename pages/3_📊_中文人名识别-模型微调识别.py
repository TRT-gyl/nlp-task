...
st.set_page_config(page_title="中文人名识别-模型微调识别", page_icon="📊", layout="wide")
st.title("中文人名识别-模型微调识别")
st.subheader('step1、微调专有LAC分词&词法分析模型')
button = st.button("微调LAC模型")
